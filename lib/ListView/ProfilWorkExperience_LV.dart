...
class ProfilWorkExperienceLV extends StatefulWidget {
  ...
  @override
  _ProfilWorkExperienceLVState createState() => _ProfilWorkExperienceLVState();
}

class _ProfilWorkExperienceLVState extends State<ProfilWorkExperienceLV> {
  var token;

...
class ProfileDetailListView extends StatefulWidget {
  ...
  @override
  _ProfileDetailListViewState createState() => _ProfileDetailListViewState();
}
          ...
          if (!snapshot.hasData) {
            ...
            return GridView(
              ...
              children: List<Widget>.generate(
                ProfileHeaderModel.popularCourseList.length,
                (int index) {
                  final int count = ProfileHeaderModel.popularCourseList.length;
                  ...
                  return ProfileHeaderModelView(
                    callback: () {
                      widget.callBack();
                    },
                    category: ProfileHeaderModel.popularCourseList[index],
                    animation: animation,
                    animationController: animationController,
                  );
                },
        ...
        return FadeTransition(
          ...
          child: Transform(
            ...
            child: InkWell(
              ...
              onTap: () {
                if (category.IDprofile == 4) {
                  Navigator.of(context).push(
                      new MaterialPageRoute(builder: (BuildContext context) {
                    //return new EmptyDataScreen();
                    return new ProfilDetailScreen(
                        animationController: animationController);
                ...
                if (category.IDprofile == 5) {
                  Navigator.of(context).push(
                      new MaterialPageRoute(builder: (BuildContext context) {
                    return new Profile_Family_New();
                    //return new EmptyDataScreen();
                    // return new ProfilScreen(
                    //     animationController:
                    //         animationController);
                ...
                if (category.IDprofile == 6) {
                  Navigator.of(context).push(
                      new MaterialPageRoute(builder: (BuildContext context) {
                    return new Profile_Education_New();
                    //return new EmptyDataScreen();
                    // return new ProfilScreen(
                    //     animationController:
                    //         animationController);
                ...
                if (category.IDprofile == 7) {
                  Navigator.of(context).push(
                      new MaterialPageRoute(builder: (BuildContext context) {
                    return new Profile_WorkEksperience_New();
                    //return new EmptyDataScreen();
                    // return new ProfilScreen(
                    //     animationController:
                    //         animationController);

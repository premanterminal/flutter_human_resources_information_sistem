...
class KPILV extends StatefulWidget {
  ...
  @override
  _KPILVState createState() => _KPILVState();
}

class _KPILVState extends State<KPILV> {
  var token;
  ...
  dataKPI(token) async {
    try {
      final response = await http.get(Uri.parse(BaseUrl.apiBaseUrl + 'kpi'),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 5, bottom: 2),
                            child: (total_nilai == null)
                                ? Text("-")
                                : Text(
                                    'Total Nilai : ' + total_nilai.toString(),
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                      fontFamily: FitnessAppTheme.fontName,
                                      fontWeight: FontWeight.w500,

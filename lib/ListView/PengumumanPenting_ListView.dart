...
class PengumumanPenting_Listview extends StatefulWidget {
  ...
  @override
  _PengumumanPenting_ListviewState createState() =>
      _PengumumanPenting_ListviewState();
}

class _PengumumanPenting_ListviewState
    extends State<PengumumanPenting_Listview> {
  var token;
  ...
  getPref() async {
    ...
    dataNewPengumumanPenting(token);
  }
  ...
  dataNewPengumumanPenting(token) async {
    try {
      final response = await http.get(
          Uri.parse(BaseUrl.apiBaseUrl + 'last-portal-penting'),

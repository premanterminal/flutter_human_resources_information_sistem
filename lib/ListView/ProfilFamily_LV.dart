...
class ProfilFamilyLV extends StatefulWidget {
  ...
  @override
  _ProfilFamilyLVState createState() => _ProfilFamilyLVState();
}

class _ProfilFamilyLVState extends State<ProfilFamilyLV> {
  var token;
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: (mobile_phone == null)
                                ? Text("-")
                                : Text(
                                    'Pendidikan Terakhir : ' + mobile_phone,
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                      fontFamily: FitnessAppTheme.fontName,
                                      fontWeight: FontWeight.w500,

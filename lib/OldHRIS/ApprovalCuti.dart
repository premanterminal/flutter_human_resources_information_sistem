...
class _ApprovalCutiState extends State<ApprovalCuti> {
  ...
  fnDataAppCuti(token) async {
    ...
    setState(() {
      ...
      // subdatacuti1 = result['data']['user_created'];
      // subdatacuti2 = result['data']['type_overtime'];
      print('lihat lihat');
      print(dataCuti);
      // print (subdatacuti1);
      // print (subdatacuti2);
  ...
  fnDataAppCutiNext(token, urlnext) async {
    if (urlnext == null) {
      showErrorDialog({
        'message': 'Perhatian',
        'errors': {
  ...
  fnDataAppCutiPrev(token, urlprev) async {
    if (urlprev == null) {
      showErrorDialog({
        'message': 'Perhatian',
        'errors': {
  ...
  Widget colomData() {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          // Map loaddata1 = subdatacuti1[index];
          // Map loaddata2 = subdatacuti2[index];
          return Container(
                      ...
                      child: Row(
                        children: [
                          IconButton(
                              ...
                              onPressed: () {
                                fnDataAppCutiNext(token, prevpageUrl);
                              },
                              icon: Icon(
                          ...
                          IconButton(
                              padding: EdgeInsets.all(0),
                              onPressed: () {
                                fnDataAppCutiNext(token, nextpageUrl);
                              },
                              icon: Icon(

...
class ApprovalLembur extends StatefulWidget {
  @override
  _ApprovalLemburState createState() => _ApprovalLemburState();
}

class _ApprovalLemburState extends State<ApprovalLembur> {
  int currentPage = 0;
  int to = 0;
  int total = 0;
  int from = 0;
  ...
  fnDataAppLembur(token) async {
    ...
    setState(() {
      ...
      // subdatalembur1 = result['data']['user_created'];
      // subdatalembur2 = result['data']['type_overtime'];
    ...
    print('lihat lihat');
    print(dataLembur);
    // print (subdatalembur1);
    // print (subdatalembur2);
  }

  fnDataAppLemburNext(token, urlnext) async {
    if (urlnext == null) {
      showErrorDialog({
        'message': 'Perhatian',
        'errors': {
  ...
  fnDataAppLemburPrev(token, urlprev) async {
    if (urlprev == null) {
      showErrorDialog({
        'message': 'Perhatian',
        'errors': {
  ...
  Widget colomData() {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          // Map loaddata1 = dataLembur[index];
          // Map loaddata2 = dataLembur[index];
          return Container(
                      ...
                      child: Row(
                        children: [
                          IconButton(
                              ...
                              onPressed: () {
                                fnDataAppLemburNext(token, prevpageUrl);
                              },
                              icon: Icon(
                          ...
                          IconButton(
                              padding: EdgeInsets.all(0),
                              onPressed: () {
                                fnDataAppLemburNext(token, nextpageUrl);
                              },
                              icon: Icon(

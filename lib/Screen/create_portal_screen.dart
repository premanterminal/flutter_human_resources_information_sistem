...
class CreatePortalScreen extends StatefulWidget {
  @override
  _CreatePortalScreenState createState() => _CreatePortalScreenState();
}

class _CreatePortalScreenState extends State<CreatePortalScreen> {

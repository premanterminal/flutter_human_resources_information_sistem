...
class TambahportalScreen extends StatefulWidget {
  const TambahportalScreen({Key? key, required this.animationController})
      : super(key: key);

  final AnimationController animationController;
  @override
  _TambahportalScreenState createState() => _TambahportalScreenState();
}

class _TambahportalScreenState extends State<TambahportalScreen>

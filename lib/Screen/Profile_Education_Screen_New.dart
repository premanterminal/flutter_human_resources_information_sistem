...
class Profile_Education_New extends StatefulWidget {
  @override
  _Profile_Education_NewState createState() => _Profile_Education_NewState();
}
...
class _Profile_Education_NewState extends State<Profile_Education_New>
                          ...
                          child: (educationList == null)
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    Map educationData = educationList[index];
                                    final int count = educationList.length > 10
                                        ? 10
                                        : hotelList.length;
                                    ...
                                    return timePanelLembur(
                                        ...
                                        educationData['GraduateYear'],
                                        educationData['HasCertificate'],
                                        animation);
                                  },
                                ),
                        ),
  ...
  Widget timePanelLembur(schollname, major, degree, startyear, graduateyear,
      certificate, Animation<double> animation) {

...
class HodCutiScreen extends StatefulWidget {
  const HodCutiScreen({Key key, this.animationController}) : super(key: key);

  final AnimationController animationController;
  @override
  _HodCutiScreenState createState() => _HodCutiScreenState();
}

class _HodCutiScreenState extends State<HodCutiScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Approval Cuti Bawahan Saya',
        subTxt: 'Details',

...
class PortalbiasaScreen extends StatefulWidget {
  const PortalbiasaScreen({Key? key, required this.animationController})
      : super(key: key);

  final AnimationController animationController;
  @override
  _PortalbiasaScreenState createState() => _PortalbiasaScreenState();
}

class _PortalbiasaScreenState extends State<PortalbiasaScreen>

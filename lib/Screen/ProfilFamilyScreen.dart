import 'package:flutter_human_resources_information_sistem/ListView/ProfilFamily_LV.dart';
...
class ProfilFamilyScreen extends StatefulWidget {
  const ProfilFamilyScreen({Key? key, required this.animationController})
      : super(key: key);

  final AnimationController animationController;
  @override
  _ProfilFamilyScreenState createState() => _ProfilFamilyScreenState();
}

class _ProfilFamilyScreenState extends State<ProfilFamilyScreen>

...
class HodlemburScreen extends StatefulWidget {
  const HodlemburScreen({Key key, this.animationController}) : super(key: key);

  final AnimationController animationController;
  @override
  _HodlemburScreenState createState() => _HodlemburScreenState();
}

class _HodlemburScreenState extends State<HodlemburScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Approval Lembur Bawahan Saya',
        subTxt: 'Details',

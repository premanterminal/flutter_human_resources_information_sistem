...
import 'package:flutter_human_resources_information_sistem/ListView/ProfilEducation_LV.dart';
...
class ProfilEducationScreen extends StatefulWidget {
  const ProfilEducationScreen({Key? key, required this.animationController})
      : super(key: key);

  final AnimationController animationController;
  @override
  _ProfilEducationScreenState createState() => _ProfilEducationScreenState();
}

class _ProfilEducationScreenState extends State<ProfilEducationScreen>

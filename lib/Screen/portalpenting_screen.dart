...
class PortalpentingScreen extends StatefulWidget {
  const PortalpentingScreen({Key? key, required this.animationController})
      : super(key: key);

  final AnimationController animationController;
  @override
  _PortalpentingScreenState createState() => _PortalpentingScreenState();
}

class _PortalpentingScreenState extends State<PortalpentingScreen>
